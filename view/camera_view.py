...
class CameraView(QMainWindow):
    ...
    def __init_ui(self):
        ...
        self.__image_label = QLabel(self.widget)
        ...
        self.__toast_view = ToastView(self.widget, 'view/styles/toast_message.css')
        self.__app_mode_toast_view = ToastView(self.widget, 'view/styles/app_mode_toast.css')
        self.__collect_progress = CollectProgressBar(self.widget, 'view/styles/collect_progress_bar.css', maximum=100)
        self.loading_gif_view = GifView(self.widget, './assets/UI/loading_gif')

        self.on_closed = None

    def square_frame(self, square_frame_size: int):
        self.__set_learn_button_style(square_frame_size)
        self.__set_verify_button_style(square_frame_size)
        self.__set_reset_button_style(square_frame_size)
        self.__set_continue_button_style(square_frame_size)
        self.__set_try_again_button_style(square_frame_size)
        self.__set_verified_view_style(square_frame_size)
        self.__set_rejected_view_style(square_frame_size)
        self.__set_toast_view_style(square_frame_size)
        self.__set_app_mode_toast_style(square_frame_size)
        self.__set_progress_bar_style(square_frame_size)
        self.__set_loading_gif_style(square_frame_size)
        self.setFixedSize(square_frame_size, square_frame_size + self.learn_button.height())
        self.__image_label.setFixedSize(square_frame_size, square_frame_size)
    ...
    def set_pix_map(self, pix_map: QPixmap):
        self.__image_label.setPixmap(pix_map)

    def set_on_closed(self, on_closed):
        self.on_closed = on_closed

    def face_status_toast(self, verify_button_is_enabled: bool, learn_button_is_enable: bool, is_visible: bool, toast_message: str):
        self.__toast_view.setVisible(is_visible)
        self.__toast_view.setText(toast_message)
        self.learn_button.setEnabled(learn_button_is_enable)
        self.verify_button.setEnabled(verify_button_is_enabled)

    def app_mode_toast(self, is_visible: bool, toast_message: None or str):
        self.__app_mode_toast_view.setVisible(is_visible)
        self.__app_mode_toast_view.setText(toast_message)

    def __set_toast_view_style(self, square_frame_size: int):
        toast_width = int(square_frame_size * 0.7)
        toast_height = square_frame_size * 0.14
        self.__toast_view.setGeometry((square_frame_size - toast_width) // 2, 0, int(toast_width), int(toast_height))

    def progressbar_update(self, is_visible: bool, value: int):
        self.__collect_progress.setVisible(is_visible)
        self.__collect_progress.setValue(value)

    def __set_app_mode_toast_style(self, square_frame_size: int):
        toast_height = square_frame_size * 0.15
        toast_width = square_frame_size
        self.__app_mode_toast_view.setGeometry((square_frame_size - toast_width) // 2, square_frame_size,
                                               int(toast_width), int(toast_height))

    def __set_learn_button_style(self, square_frame_size: int):
    ...
    def __set_verify_button_style(self, square_frame_size: int):
        button_height = square_frame_size * 0.15
    ...
    def __set_reset_button_style(self, square_frame_size: int):
        button_height = square_frame_size * 0.15
    ...
    def __set_continue_button_style(self, square_frame_size: int):
        button_height = square_frame_size * 0.15
        button_width = square_frame_size
    ...
    def __set_try_again_button_style(self, square_frame_size: int):
        button_height = square_frame_size * 0.15
        button_width = square_frame_size
    ...
    def __set_progress_bar_style(self, square_frame_size: int):
        progress_bar_height = square_frame_size * 0.02
        progress_bar_width = square_frame_size
        self.__collect_progress.setGeometry((square_frame_size - progress_bar_width) // 2,
                                            int(square_frame_size - progress_bar_height),
                                            progress_bar_width, int(progress_bar_height))

    def __set_loading_gif_style(self, square_frame_size: int):
    ...
    def __set_verified_view_style(self, square_frame_size: int):
    ...
    def __set_rejected_view_style(self, square_frame_size: int):
