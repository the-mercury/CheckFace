# Highly inspired by: https://github.com/davidsandberg/facenet & https://github.com/nyoki-mtl/keras-facenet
...
class InceptionResNetV2(keras.layers.Layer):

    def __init__(self, weights):
        super(InceptionResNetV2, self).__init__()
        self.model = self.__inception_resnet()
